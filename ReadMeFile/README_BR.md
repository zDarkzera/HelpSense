...
[Site Oficial](https://helpsense.scpslgame.cn/) [Site de Documentação da API](https://xlittleleft.github.io/HelpSense/api/HelpSense.html)
[Servidor do Discord](https://discord.gg/beDyW4cgCB)

# HelpSense TranslateFile
Você está procurando o arquivo de configuração para seu país? -> [Arquivos de Idiomas](TranslateFile)
...
- Limpeza no servidor (limpa os corpos e itens inúteis para reduzir o carregamento do servidor).
...
- Chance de renascimento, tempo, ogiva alfa (nuke) display (Estamos reaparecendo?).
...
- FTM Kappa-10 "Skynet" (079 não ganhou? Desculpe, Skynet FTM vem com um holofote poderoso e com velocidade no início dos geradores).
...
- Consulta de informação de jogador (Deseja saber há quanto tempo você joga no servidor ou quantos abates você fez? Use o .info!).
- FTM Eta-10 "Não Vê Mal" (Acidentalmente você olha para o SCP-096 todo tempo como NTF? Entre no esquadão "See No Evil" da FTM e olhe para onde você quiser!).
...
- SCP-023 (Eu posso passar livremente pela porta).

## Instalando o plugin
Faça download do **arquivo zip mais recente na seção de Release** e extraia tudo no diretório: `\PluginAPI\plugins\global.`.
...
## Pelo desenvolvimento(Em ordem alfabética)
- moddedmcplayer
- sssssssthedev
- SrLicht
- 1312255201
...
## Pela tradução(Em ordem alfabética)
- Inglês : SpankyR,Kanekuu
- Alemão : moddedmcplayer
- Francês: SmulCapa
- Italiano : Zurna_sever_58
- Turco : Xela
- Espanhol : SpankyR
- Português-Brasil : zDarkzera e Firething
- Russo : Bread[IDDQD] , RisottoMan
- Eslovaco : blackstrikesk
- Chinês tradicional : Alter
- Polonês : Kanekuu

## Código de Referência(Em ordem alfabética)
...
## Fonte de inspiração para design de personagens SCP do plugin especial
https://scp-wiki-cn.wikidot.com/

## Imagens funcionais parciais (uma parte muito pequena)
